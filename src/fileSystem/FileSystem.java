...
public class FileSystem {
    ...
    /**
     * Creates the root directory and root user
     */
    public FileSystem() {
    ...
    /**
     * system method to add a new user and creates a new folder with user's name
     * in /
     * 
     * @param args
    ...
    /**
     * system method to check if a user exists in the file system
     * 
     * @param name
     *            user's name
     * @return
    ...
    /**
     * For security reasons, only file system can access another directories
     * 
     * @param path
     * @param absolute
     * @param args
